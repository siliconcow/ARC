...
class Ace(models.Model):
    ...
    target = models.CharField(blank=False, unique=True, max_length=255, help_text="The string to pass to the command.  You can use ${args} to use the entire query string or ${arg0}..${argN} to use individual parameters. You can also use basic python expressions with ${}")
